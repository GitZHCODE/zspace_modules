...
namespace  zSpace
{
	...
	*	\since version 0.0.4
	*/
	extern "C" ZSPACE_MODULES bool ccfSolver_initialise(double* _vertexPositions, int* _polyCounts, int* _polyConnects, int numVerts, int numFaces, double* outPlanarityDeviations, double* outGaussianCurvatures);
